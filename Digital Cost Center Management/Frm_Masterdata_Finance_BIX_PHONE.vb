Public Class Frm_Masterdata_Finance_BIX_PHONE
    Dim value_smart As String
    ...
    Private Sub initialize()
        ...
        ExecuteQuery("SELECT tbl_employeemaster.LName,tbl_employeemaster.FName,tbl_employeemaster.MName,tbl_employeephoneacct.Acct_no,tbl_employeephoneacct.Service_no,tbl_employeephoneacct.MonthlyAllowance,tbl_employeephoneacct.PhoneType,tbl_employeephoneacct.smartID,tbl_employeephoneacct.PhoneStatus FROM tbl_employeephoneacct LEFT JOIN tbl_employeemaster ON tbl_employeephoneacct.EmployeeID=tbl_employeemaster.EmployeeID ORDER BY LName ASC")
        ...
        If datareader.HasRows Then
            While (datareader.Read)
                ...
                ListView2.Items(ListView2.Items.Count - 1).SubItems.Add(datareader("smartID"))
            End While
        End If
        conn.Close()
    End Sub
    ...
    Private Sub txtsearch_TextChanged(sender As Object, e As EventArgs) Handles txtsearch.TextChanged
        ListView2.Items.Clear()
        ExecuteQuery("SELECT tbl_employeemaster.LName,tbl_employeemaster.FName,tbl_employeemaster.MName,tbl_employeephoneacct.Acct_no,tbl_employeephoneacct.Service_no,tbl_employeephoneacct.MonthlyAllowance,tbl_employeephoneacct.PhoneType,tbl_employeephoneacct.smartID,tbl_employeephoneacct.PhoneStatus FROM tbl_employeephoneacct LEFT JOIN tbl_employeemaster ON tbl_employeephoneacct.EmployeeID=tbl_employeemaster.EmployeeID WHERE LName LIKE '" & txtsearch.Text & "%' ORDER BY LName ASC")
        datareader = cmd.ExecuteReader
        If datareader.HasRows Then
            While (datareader.Read)
                ListView2.Items.Add(datareader("LName"))
    ...
    Private Sub trap()
        ...
        Else
            ExecuteQuery("SELECT COUNT(*) as count_employee FROM tbl_employeephoneacct WHERE EmployeeID=" & empid & " AND PhoneStatus=0")
            datareader = cmd.ExecuteReader
        ...
        If bttnsave.Text = "SAVE" Then
            ...
            If n = vbYes Then
                ...
                Else
                    ...
                    ExecuteQuery("INSERT INTO tbl_employeephoneacct (EmployeeID,Acct_no,Service_no,MonthlyAllowance,PhoneType,PhoneStatus) VALUES(" & empid & ",'" & txtacct_no.Text.Replace("'", "''") & "','" & txtservice_no.Text.Replace("'", "''") & "'," & txtmonthly_allowance.Text & ",'" & cbophone_type.Text & "'," & phonestatus & ")")
        ...
        Else
            ...
            If n = vbYes Then
                ...
                If internet_connection = False Then
                    ...
                    Exit Sub
                Else
                    ExecuteQuery("UPDATE tbl_employeephoneacct SET Acct_no='" & txtacct_no.Text.Replace("'", "''") & "', Service_no='" & txtacct_no.Text.Replace("'", "''") & "', MonthlyAllowance=" & txtmonthly_allowance.Text & ", PhoneType='" & cbophone_type.Text & "', PhoneStatus=" & phonestatus & " WHERE smartID='" & value_smart & "'")
    ...
    Private Sub ListView2_DoubleClick(sender As Object, e As EventArgs) Handles ListView2.DoubleClick
        ...
        value_smart = ListView2.SelectedItems(0).SubItems(8).Text
    ...
    Private Sub ListView1_KeyDown(sender As Object, e As KeyEventArgs) Handles ListView1.KeyDown
        ...
        End If
    End Sub
    Private Sub Frm_Masterdata_Finance_BIX_PHONE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call initialize()
    End Sub
End Class