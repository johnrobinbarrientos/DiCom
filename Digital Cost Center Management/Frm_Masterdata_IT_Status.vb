Public Class Frm_Masterdata_IT_Status
    ...
    Private Sub initialize()
        ...
        ExecuteQuery("SELECT * FROM tbl_itassetstatus ORDER BY Status ASC")
        datareader = cmd.ExecuteReader
        If datareader.HasRows Then
            While (datareader.Read)
                ListView2.Items.Add(datareader("StatusID"))
    ...
    Private Sub trap()
        ...
        Else
            ...
            ExecuteQuery("SELECT COUNT(*) as count_status FROM tbl_itassetstatus WHERE Status='" & txtstatus.Text.Replace("'", "''") & "'")
            datareader = cmd.ExecuteReader
        ...
        If bttnsave.Text = "SAVE" Then
                ...
                If n = vbYes Then
                    ...
                    If internet_connection = False Then
                        ...
                        Exit Sub
                    Else
                        ExecuteQuery("INSERT INTO tbl_itassetstatus (Status) VALUES('" & txtstatus.Text.Replace("'", "''") & "')")
            ...
            Else
                ...
                If n = vbYes Then
                    ...
                    If internet_connection = False Then
                        ...
                        Exit Sub
                    Else
                        ExecuteQuery("UPDATE tbl_itassetstatus SET Status='" & txtstatus.Text.Replace("'", "''") & "' WHERE StatusID='" & value_statusID & "'")
    ...
    Private Sub txtsearch_TextChanged(sender As Object, e As EventArgs) Handles txtsearch.TextChanged
        ...
        If internet_connection = False Then
            ...
            Exit Sub
        Else
            ExecuteQuery("SELECT * FROM tbl_itassetstatus WHERE Status LIKE '%" & txtsearch.Text.Replace("'", "''") & "%' ORDER BY Status ASC")
            datareader = cmd.ExecuteReader
        End If
    ...
    Private Sub Frm_Masterdata_IT_Status_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call initialize()
    End Sub
